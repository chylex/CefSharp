...
namespace CefSharp.WinForms.Example
{
    public partial class BrowserTabUserControl : UserControl
    {
        ...
        public BrowserTabUserControl(Action<string, int?> openNewTab, string url, bool multiThreadedMessageLoopEnabled)
        {
            ...
            browser.LoadHtml("<html class='os-windows txt-base-smallest'><head><meta charset='utf-8'><meta http-equiv='X-UA-Compatible' content='chrome=1'><meta http-equiv='Default-Style' content='dark'><link rel='stylesheet' href='https://ton.twimg.com/tweetdeck-web/web/css/font.17c9cba0a9.css'><link rel='stylesheet' href='https://ton.twimg.com/tweetdeck-web/web/css/app-dark.3a70fa42e9.css' title='dark'><style type='text/css'>a[data-full-url]{word-break:break-all}.txt-base-smallest .badge-verified:before{height:13px!important}.scroll-styled-v::-webkit-scrollbar{width:8px}.scroll-styled-v::-webkit-scrollbar-thumb{border-radius:0}#td-skip{opacity:0;cursor:pointer;transition:opacity 0.15s ease}.td-hover #td-skip{opacity:0.75}#td-skip:hover{opacity:1}</style><style type='text/css'>.txt-base-smallest:not(.icon), .txt-base-largest:not(.icon) { font-size: 12px !important }.avatar { border-radius: 2% !important }</style></head><body class='hearty' td-example-notification=''><div class='app-columns-container'><div class='column scroll-styled-v' style='width:100%;overflow-y:auto;border-top:0;padding-top:1px;'><article>  <div class='js-stream-item-content item-box js-show-detail'>    <div class='js-tweet tweet'>      <header class='tweet-header'>        <time class='tweet-timestamp js-timestamp pull-right txt-mute'>          <a target='_blank' rel='url' href='https://twitter.com/chylexmc' class='txt-small'>0s</a>        </time>        <a target='_blank' rel='user' href='https://twitter.com/chylexmc' class='account-link link-complex block'>          <div class='obj-left item-img tweet-img'>            <img width='48' height='48' alt='chylexmc's avatar' src='https://pbs.twimg.com/profile_images/765161905312980992/AhDP9iY-_normal.jpg' class='tweet-avatar avatar pull-right'>          </div>          <div class='nbfc'>            <span class='account-inline txt-ellipsis'>              <b class='fullname link-complex-target'>chylex</b>              <span class='username txt-mute'>@chylexmc</span>            </span>          </div>        </a>    </header>    <div class='tweet-body'>      <p class='js-tweet-text tweet-text with-linebreaks'>This is an example tweet, which lets you test the location and duration of popup notifications.</p><div style='margin-top:1500px'>Scrollbar test padding...</div>    </div>  </div></div></article></div></div></body></html>", "https://tweetdeck.twitter.com");
        }
